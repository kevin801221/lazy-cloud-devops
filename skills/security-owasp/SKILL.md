---
name: security-owasp
description: "[lazy-superstack · 資安] Use when reviewing code for security vulnerabilities, implementing authentication/authorization, handling user input, or discussing web application security. Covers OWASP Top 10:2025, ASVS 5.0, LLM Top 10 (2025), and Agentic AI security (2026). Vendored from agamm/claude-code-owasp."
allowed-tools: Read Grep Glob
---

> **📥 Vendored skill** — 原始來源 [agamm/claude-code-owasp](https://github.com/agamm/claude-code-owasp)（MIT，© 2026 agamm）。
> 由 lazy-superstack 收錄；僅修改 frontmatter `name` 為 `security-owasp`，內容未改動。完整授權見同目錄 `LICENSE`。
